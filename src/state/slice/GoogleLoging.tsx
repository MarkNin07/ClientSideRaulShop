...
import { logInInReducer } from "./LoggedInSlice";
...
const GoogleLogIn: React.FunctionComponent = () => {
  ...
  return (
    <div>
      <button onClick={signInWithGoogleButton}
      className="bg-blue-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Log in with google</button>
    </div>
  );
};
